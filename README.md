...
## 🖼️ Visual Interface Showcase (ภาพรวมหน้าจอและฟังก์ชันการใช้งาน)

| 📱 Customer Mobile Intake (จุดกดรับคิวบนมือถือ) | 🎫 Real-time Digital Pass (บัตรคิวดิจิทัล) |
|:---:|:---:|
...
| **EN**: Service selection (A/B/C), live wait calculation & instant token pass.<br/>**TH**: เลือกหมวดบริการ (A/B/C), คำนวณเวลารอเรียลไทม์ & ออกบัตรคิวทันที | **EN**: Live status tracker, queue position countdown & counter check-in QR.<br/>**TH**: ติดตามสถานะคิวสด, นับถอยหลังลำดับคิว & QR สำหรับเช็คอิน |
...
| **EN**: Multi-desk switcher, atomic Call Next (SKIP LOCKED) & audio chime recall.<br/>**TH**: สลับโต๊ะบริการ, เรียกคิวไร้การชนกัน & ขานซ้ำเสียงระฆัง Chime | **EN**: 16:9 public display, Next-in-Line board & bilingual speech calling.<br/>**TH**: จอ 16:9 แสดงผลคิวสด, บอร์ดคิวถัดไป & เสียงสังเคราะห์ขานคิว TH/EN |
...
| **EN**: Service/counter CRUD, letter prefix locking (A/B/C) & desk binding.<br/>**TH**: จัดการบริการ/โต๊ะ, ล็อกรหัสย่อห้ามซ้ำ & ผูกประเภทบริการเฉพาะโต๊ะ | **EN**: Print-ready A4 tent standee generator for entrance & service counters.<br/>**TH**: สร้างป้าย QR พับตั้งโต๊ะขนาด A4 สำหรับจุดทางเข้าและประจำเคาน์เตอร์ |
